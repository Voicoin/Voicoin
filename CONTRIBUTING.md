Contributing to voi Core
============================

The voi Core project operates an open contributor model where anyone is
...
The following applies to code changes to the voi Core project, and is not to be
confused with overall voi Network Protocol consensus changes.

Whether a pull request is merged into voi Core rests with the project merge
...
Patches that change voi consensus rules are considerably more involved than
...
Where a patch set proposes to change the voi consensus, it must have been
...
The project leader is the release manager for each voi Core release.
