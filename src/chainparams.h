 ...
 * voi system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& voiDevKey() const { return vvoiDevKey; }
    // const std::vector<unsigned char>& voiFundKey() const { return vvoiFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vvoiDevKey;
    // std::vector<unsigned char> vvoiFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
