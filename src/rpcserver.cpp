...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* voi features */
        {"voi", "masternode", &masternode, true, true, false},
        {"voi", "listmasternodes", &listmasternodes, true, true, false},
        {"voi", "getmasternodecount", &getmasternodecount, true, true, false},
        {"voi", "masternodeconnect", &masternodeconnect, true, true, false},
        {"voi", "masternodecurrent", &masternodecurrent, true, true, false},
        {"voi", "masternodedebug", &masternodedebug, true, true, false},
        {"voi", "startmasternode", &startmasternode, true, true, false},
        {"voi", "createmasternodekey", &createmasternodekey, true, true, false},
        {"voi", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"voi", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"voi", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"voi", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"voi", "getmasternodescores", &getmasternodescores, true, true, false},
        {"voi", "mnsync", &mnsync, true, true, false},
        {"voi", "spork", &spork, true, true, false},
        {"voi", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"voi", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use void, or the -server option to voi-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> voi-cli " + methodname + " " + args + "\n";
}
