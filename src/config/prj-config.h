/* src/config/voi-config.h.  Generated from voi-config.h.in by configure.  */
/* src/config/voi-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.voi.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "voi Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "voi Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "voi"
