...
#if defined(NDEBUG)
#error "voi cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uvoi) are considered zero fee (for relaying and mining)
