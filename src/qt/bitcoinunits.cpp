...
// Copyright (c) 2017-2018 The voi Core developers
...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(voi);
   // unitlist.append(mvoi);
   // unitlist.append(uvoi);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case voi:
            return QString("voi");
        case mvoi:
            return QString("Milli-voi (1 / 1" THIN_SP_UTF8 "000)");
        case uvoi:
            return QString("Micro-voi (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case voi:
            return QString("Testvois");
        case mvoi:
            return QString("Milli-Testvois (1 / 1" THIN_SP_UTF8 "000)");
        case uvoi:
            return QString("Micro-Testvois (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
