...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::voi, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (voi.conf).");
            QMessageBox::warning(this, "voi Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#ea616f;}\n a, span { font-family: monospace; }\n span.addr {color:#ea616f; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #ea616f;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#ea616f;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#ea616f;}\n";
