...
#   c) node1 mines 32 blocks, so now node 0 has 60001voi, node 1 has 4250voi, node2 has none.
#   d) node0 sends 601 voi to node2, in two transactions (301 voi, then 300 voi).
