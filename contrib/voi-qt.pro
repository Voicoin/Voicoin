...
RESOURCES += src/qt/voi.qrc src/qt/voi_locale.qrc

TRANSLATIONS += src/qt/locale/voi_bg.ts \
                src/qt/locale/voi_de.ts \
                src/qt/locale/voi_en.ts \
                src/qt/locale/voi_es.ts \
                src/qt/locale/voi_fi.ts \
                src/qt/locale/voi_fr.ts \
                src/qt/locale/voi_it.ts \
                src/qt/locale/voi_ja.ts \
                src/qt/locale/voi_pl.ts \
                src/qt/locale/voi_pt.ts \
                src/qt/locale/voi_ru.ts \
                src/qt/locale/voi_sk.ts \
                src/qt/locale/voi_sv.ts \
                src/qt/locale/voi_vi.ts \
                src/qt/locale/voi_zh_CN.ts \
                src/qt/locale/voi_zh_TW.ts
