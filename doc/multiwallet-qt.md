...
In order to support loading of multiple wallets in voi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is voi.cpp.
...
Changes to voi.cpp
----------------------
voi.cpp is the entry point into voi-qt, and as such, will require some minor modifications to provide hooks for
